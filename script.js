...
/*btnScrollTo.addEventListener('click', function (e) {
  ...
  // console.log('current scroll (X/Y)', window.pageXOffset, pageYOffset) // distance base on the view port to the top of the page
...
// Apply bubbling to the links parent instead of looping through all
document.querySelector('.nav__links').addEventListener('click', function (e) {
  e.preventDefault();
...
//   // enntries are array of threshold entry
//   entries.forEach(entry => {
//     console.log(entry)
//   })
// }
